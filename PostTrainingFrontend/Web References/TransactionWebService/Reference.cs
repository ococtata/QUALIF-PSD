...
namespace PostTrainingFrontend.TransactionWebService {
    ...
    public partial class TransactionWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public TransactionWebService() {
            this.Url = global::PostTrainingFrontend.Properties.Settings.Default.PostTrainingFrontend_TransactionWebService_TransactionWebService;
        ...
        /// <remarks/>
        public void GetUserTransactionsAsync(string userId) {
            this.GetUserTransactionsAsync(userId, null);
        }
        
        /// <remarks/>
        public void GetUserTransactionsAsync(string userId, object userState) {
            ...
            this.InvokeAsync("GetUserTransactions", new object[] {
                        userId}, this.GetUserTransactionsOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void CreateTransactionAsync(string userId, CartItemInput[] cartItems) {
            this.CreateTransactionAsync(userId, cartItems, null);
        }
        
        /// <remarks/>
        public void CreateTransactionAsync(string userId, CartItemInput[] cartItems, object userState) {
            ...
            this.InvokeAsync("CreateTransaction", new object[] {
                        userId,
                        cartItems}, this.CreateTransactionOperationCompleted, userState);
        }
    ...
    public partial class CartItemInput {
